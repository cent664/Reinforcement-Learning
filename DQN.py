...
def DQN_Agent(mode, stock, trend, window_size):
    ...
    if mode == 'Train':
        ...
        # DQN Stocks
        env = StockTradingEnv(mode, steps, trend, window_size)  # Object of the environment
    ...
    if mode == 'Test':
        ...
        # DQN Stocks
        env = StockTradingEnv(mode, test_steps, trend, window_size)  # Resetting the environment
