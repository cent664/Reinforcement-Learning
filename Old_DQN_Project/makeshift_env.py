...
class StockTradingEnv:
    ...
    def __init__(self, mode, steps, stock, trend):
        ...
        for i in range(0, steps):
            maxRange = max(maxRange, max(self.data_stocks_high[i:i + self.window_size]) - min(self.data_stocks_low[i:i + self.window_size]))
